...
async function loadVideo(url) {
    ...
    try {
        ...
        if (data.streams && data.streams.length > 0) {
            ...
            // FIX: Tampilkan pesan error yang informatif + tombol retry & ganti server
            player.src = '';
            serverContainer.innerHTML = `
                <div style="width:100%;padding:20px;text-align:center;color:var(--text-muted);">
                    <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" style="margin-bottom:12px;opacity:0.5"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                    <p style="margin:0 0 6px;font-weight:600;color:var(--text)">Stream Tidak Tersedia</p>
                    <p style="margin:0 0 16px;font-size:13px;">Server belum menyediakan video untuk episode ini, atau proxy sedang bermasalah.</p>
            ...
            // FIX: Log detail error ke console untuk debugging
            console.error('[loadVideo] Stream kosong. Response dari API:', data);
        }
    } catch (err) {
